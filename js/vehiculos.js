import { initializeApp } from "https://www.gstatic.com/firebasejs/12.3.0/firebase-app.js";
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            try {
                ...
                animateCountUp(document.getElementById("propulsoresActivos"), activos);
                animateCountUp(document.getElementById("propulsoresNoActivos"), noActivos);
                ...
                if (statsSnap.exists()) {
                    ...
                    animateCountUp(document.getElementById("lanzamientostFalcon9"), totalFalcon9);

                    animateCountUp(document.getElementById("exitoFalconHeavy"), falconHeavyStats.exitosos);
                    animateCountUp(document.getElementById("lanzamientostFalconHeavy"), totalFalconHeavy);
                }
